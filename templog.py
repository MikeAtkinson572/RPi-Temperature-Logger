...
while (number_of_sensors!=0):
    ...
    with open('./temperature_log.csv', 'a') as f:
        ...
        # BIT OF A KLUDGE FOR SPECIFIC SENSORS
        device_file = base_dir + '28-0414608bbdff' + '/w1_slave'
        temp1 = read_temp()
        device_file = base_dir + '28-0000074aaacd' + '/w1_slave'
        temp2 = read_temp()

        f.write(", " +str(temp2) +", " +str(temp1))
        f.write("\n")
    led_off()

    sendData(THINGSPEAKURL,THINGSPEAKKEY,'field1',temp1,'field2',temp2)
    sys.stdout.flush()
